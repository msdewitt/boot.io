var Q = Quintus().include("Sprites, Scenes").setup({maximize: true, development: true});
...
Q.Sprite.extend("Player",{
  ...
  init: function(p) {
    ...
    this._super(p, {
      sheet: "Images/playerDEF.png",  // Setting a sprite sheet sets sprite width and height
